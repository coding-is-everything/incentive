<div class="content-wrapper">
    ...
    <?php } ?>
              <div class="card-body">
                <form method="post" action="<?php echo site_url() ?>Course/edit/<?php echo $course['courseId']; ?>">
                  <!-- input states -->

                  <div class="form-group">
                    <label class="col-form-label" for="inputSuccess"><i class="fas fa-check"></i> Course Name</label>
                    <input  type="text" class="form-control is-valid" name="courseName" id="inputSuccess" placeholder="Enter the course name" value="<?php echo !empty($course['courseName'])?$course['courseName']:''; ?>">
                   ...
                   <div class="form-group">
                    ...
                    <input  type="text" class="form-control is-valid" name="coursePrice" id="inputSuccess" placeholder="Enter the course price" value="<?php echo !empty($course['coursePrice'])?$course['coursePrice']:''; ?>">
                    ...
                    <div class="form-group clearfix">
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary1" name="courseStatus" value="1"  <?php 
    echo set_value('courseStatus', $course['courseStatus']) == 1 ? "checked" : ""; 
?> >
                        <label for="radioPrimary1">Active
                        </label>
                      </div>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary2" name="courseStatus" value="0" <?php 
    echo set_value('courseStatus', $course['courseStatus']) == 0 ? "checked" : ""; 
?>>
