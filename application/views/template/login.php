...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Sign In</a>
    </div>
    <div class="card-body">
      ...
      <form action="<?php echo site_url() ?>Login/auth" method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" required  name="userEmail" placeholder="Email">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" required  name="userPassword" placeholder="Password">
          <div class="input-group-append">
            <div class="input-group-text">
