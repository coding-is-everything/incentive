...
--
-- Host: 127.0.0.1:3310
-- Generation Time: Jul 19, 2022 at 05:16 AM
...
CREATE TABLE `incentives` (
  ...
  `courseCommited` varchar(500) NOT NULL,
  `courseDiscount` varchar(500) NOT NULL,
  `actualCourseFee` varchar(500) NOT NULL,
  `coursePriceGiven` varchar(500) NOT NULL,
  `coursePriceRemain` varchar(500) NOT NULL,
  `transDate` varchar(500) NOT NULL,
  `nextDate` varchar(500) NOT NULL,
  ...
  `teamLeadIncentive` varchar(500) NOT NULL,
  `createdDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `incentives` (`incentiveId`, `batchId`, `userId`, `studentId`, `courseCommited`, `courseDiscount`, `actualCourseFee`, `coursePriceGiven`, `coursePriceRemain`, `transDate`, `nextDate`, `roleType`, `incecntivePer`, `courseIncentive`, `checked`, `teamLeadName`, `teamLeadPer`, `teamLeadIncentive`, `createdDate`, `updatedDate`) VALUES
(9, 4, 3, 2, '75000', '1000', '74000', '5000', '69000', '', '07/23/2022', 'Individual Contributor', '0.03', '150', '1', 'Sushma', '0.07', '350.00000000000006', '2022-07-15 16:03:16', '2022-07-15 16:03:16'),
(10, 2, 6, 4, '25000', '1000', '24000', '15000', '9000', '', '08/06/2022', 'Individual Contributor', '0.03', '450', NULL, '', '', '', '2022-07-15 16:12:45', '2022-07-15 16:12:45'),
(11, 4, 6, 5, '75000', '1000', '74000', '22000', '52000', '07/12/2022', '08/06/2022', 'Individual Contributor', '0.03', '660', '1', 'Sushma', '0.07', '1540.0000000000002', '2022-07-19 02:38:16', '2022-07-19 02:38:17');
...
INSERT INTO `sales` (`saleId`, `batchId`, `userId`, `studentId`, `price`, `coursePriceCommited`, `courseDiscount`, `couesePriceGiven`, `coursePriceRemain`, `transactionDate`, `nextCommitedDate`, `screenShot`, `details`, `saleStatus`, `createdDate`, `updatedDate`) VALUES
...
INSERT INTO `users` (`userId`, `roleId`, `userName`, `userMobile`, `userEmail`, `userPassword`, `userStatus`, `createdDate`, `updatedDate`) VALUES
(2, 1, 'admin', '1234567890', 'admin@gmail.com', 'YWRtaW4=', '1', '2022-06-20 20:50:29', '2022-06-30 07:52:22'),
(3, 2, 'Girish', '1234567890', 'staff@gmail.com', 'c3RhZmZAMTIz', '1', '2022-06-20 20:50:29', '2022-06-30 07:52:15'),
(4, 3, 'Manjiri', '123456789', 'stud@gmail.com', 'c3R1ZGVudEAxMjM=', '1', '2022-06-20 20:51:42', '2022-06-30 07:51:57'),
(5, 2, 'Pranita', '1234567890', 'p@gmail.com', 'cHJhbml0YUAxMjM=', '1', '2022-06-26 00:46:57', '2022-06-30 07:51:18'),
(6, 2, 'manisha', '1234569871', 'm@gmail.com', 'bWFuaXNoYUAxMjM=', '1', '2022-06-26 00:48:36', '2022-06-30 07:51:01'),
(8, 4, 'Sushma', '1234567890', 'sh@gmail.com', 'c3VzaG1hQDEyMw==', '1', '2022-07-07 16:05:08', '2022-07-07 16:05:09');
...
--
ALTER TABLE `incentives`
  MODIFY `incentiveId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
